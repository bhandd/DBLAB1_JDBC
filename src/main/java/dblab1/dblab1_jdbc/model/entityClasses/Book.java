...
public class Book {
    ...
    public Book(int bookId, String isbn, String title, String author , java.sql.Date published, int genre_id, int grade   ) {
        this.bookId = bookId;
...
//    }
    ...
    public String toString() {
        return bookId +", "+ isbn + ", " + title + ", " + author + /*+ authors +*/ ", " +  published + ", " + genre_id + ", " + grade;
    }
}
